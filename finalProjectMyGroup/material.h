...
void new_material(float* materialh)

{ 
    material.a[0] = materialh[0]; 
    material.a[1] = materialh[1]; 
    material.a[2] = materialh[2]; 
    material.a[3] = materialh[3]; 
    material.d[0] = materialh[4]; 
    material.d[1] = materialh[5]; 
    material.d[2] = materialh[6]; 
    material.d[3] = materialh[7]; 
    material.s[0] = materialh[8]; 
    material.s[1] = materialh[9]; 
    material.s[2] = materialh[10]; 
    material.s[3] = materialh[11]; 
    material.e[0] = 0; 
    material.e[1] = 0; 
    material.e[2] = 0; 
    material.e[3] = 0; 
    material.sh  = materialh[12]; 
}

float Blue1[] = {
    0.32, 0.32, 1.0, 1.000000,
    0.15, 0.31, 1.0, 1.000000,
    0.60, 0.52, 1.0, 1.000000,
    10.0
};
